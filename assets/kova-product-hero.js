...
(function () {
    ...
    document.querySelectorAll('.kova-section').forEach(function (section) {
        const sectionId = section.querySelector('[id^="KÖVABuyBox-"]');
        if (!sectionId) return;

        const id = sectionId.id.replace('KÖVABuyBox-', '');
        const variantJsonEl = document.getElementById('KÖVAVariantJson-' + id);
        const variantIdInput = document.getElementById('KÖVAVariantId-' + id);
        const priceEl = document.getElementById('KÖVAPrice-' + id);
        ...
        swatchInputs.forEach(function (input) {
            input.addEventListener('change', function () {
                ...
                const labelEl = document.getElementById('KÖVAOptionLabel-' + id + '-' + optionIndex);
                ...
                if (matchedVariant && variantIdInput) {
                    ...
                    if (atcBtn) {
                        if (matchedVariant.available) {
                            ...
                            if (atcBtn.querySelector('.kova-atc-price')) {
